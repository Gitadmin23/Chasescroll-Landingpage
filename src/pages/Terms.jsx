    ...
    return(
        <div className=" w-full flex flex-col font-normal text-[#1E1E1E] leading-[211.7%] py-8 lg:px-20 px-0 lg:py-20 " >
            <div className=" flex justify-center relative mb-4" >
                ...
                <svg className=" absolute z-20 right-0 " onClick={()=> navigate("/")} role="button" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g id="close">
            ...
            <div className=" w-full flex justify-end mt-8 " >
                <button onClick={()=> navigate("/")}  className=" w-full lg:w-[225px] h-[55px] border border-[#5D70F9] bg-[#D0D4EB45] rounded text-[#3C41F0] font-semibold text-lg " >Back </button>
            </div>
        </div>
    )
}